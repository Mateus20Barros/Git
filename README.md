...
__The command git log displays committed snapshots. It allows you to list and filter project history and search for specific changes. While it git status 
allows the working directory and staging area to be inspected, it git log only works with committed history.__
